...
async def message_to_admin_start(message: types.Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="💬 Написать администратору", url="https://t.me/yamovsar")]
    ])
    await message.answer("Нажмите кнопку, чтобы написать администратору напрямую:", reply_markup=kb)
